#!/usr/bin/env python3
"""Update the Sparkle appcast after a release.

Reads the <zip>.sparkle.json metadata file produced by package-app.sh and
inserts a new <item> at the top of docs/appcast.xml. The item's description
(shown in Sparkle's update dialog) is extracted from the release's section in
CHANGELOG.md, falling back to a link to the GitHub release notes.
"""
import argparse
import html
import json
